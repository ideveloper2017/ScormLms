...
| UAT-559-09 | 9 | Tanlangan elektron resursning muallif, til, manba, versiya va revision tarixini ochish; so'ng O'zDSt 36.2030 checklist, ekspertiza va sertifikatni tekshirish | Har tahrir yangi noyob versiya bo'ladi, eski snapshot o'zgarmaydi va resurs tasdiqlovchi hujjat bilan bog'lanadi | Metadata/revision testi, teacher history UI, checklist/protokol/sertifikat |  |
