...
| Talaba kartochkasi va o'qishga qabul | Shaxsiy ma'lumotni akademik biriktirishdan ajratish | `src/pages/student-management.tsx`, `src/pages/admin/student-classifiers.tsx`, `src/lib/student-api.ts`, `src/lib/classifier-api.ts` | V56 ikki bosqichli real API; V58 shaxsiy forma, V59 kaskadli qabul, V60 reyestr/export va V63 selectorlar yakunlandi. V64 admin ekranida 249 ISO mamlakati, 14 SOATO hududi va 206 tuman/shahar uchun versiya, SHA-256, manba havolalari hamda idempotent bundled import holatini ko'rsatadi. V65 PostgreSQL upgrade/import UATda legacy FK va local yozuvlar saqlanishi tasdiqlandi | Admin import paneli va personal selectorlarni real HTTP/browser E2E smoke-test qilish |
