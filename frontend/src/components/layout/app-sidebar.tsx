...
const ITEMS = {
  ...
  sTranscript:    { name: "Transkript",          href: "/student/transcript",    icon: ScrollText      },
  sReports:       { name: "O'qish hisoboti",     href: "/student/reports",       icon: BarChart3       },
  sResources:     { name: "O'quv resurslari",    href: "/student/resources",     icon: Library         },
...
export function buildNav(role: string): NavGroup[] {
  ...
  const groups: Record<string, NavGroup[]> = {
    ...
    STUDENT: [
      ...
      { label: "Ta'lim",    items: [ITEMS.sOrientation, ITEMS.sPractice, ITEMS.sAssessmentLeave, ITEMS.sStudyPlan, ITEMS.sCourses, ITEMS.sResources, ITEMS.sSchedule, ITEMS.sAssignments, ITEMS.sTests, ITEMS.sExams, ITEMS.sAttestations] },
      { label: "Natijalar", items: [ITEMS.sGrades, ITEMS.sTranscript, ITEMS.sReports, ITEMS.sAttendance] },
