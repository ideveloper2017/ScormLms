...
export interface SessionDefense { defenseId: string; studentId: string; studentName: string; studentEmail: string; defenseStatus: string; defenseDate?: string; defenseTime?: string; commissionDecision?: string; averageScore?: number; certificateIssued: boolean; }
...
export interface StudentAttestation { id: string; courseId: string; courseTitle: string; title: string; description?: string; examDate: string; examTime: string; location: string; defenseType: string; chairName: string; status: AttestationStatus; myDefenseStatus?: string; myDefenseDecision?: string; myScore?: number; certificateIssued: boolean; certificateNumber?: string; resultPublished: boolean; }
...
export const attestationApi = {
  ...
  recordDefense: async (id: string) => (await api.post(`/defenses/${id}/record`, { defenseStatus: 'DEFENDED' })).data,
